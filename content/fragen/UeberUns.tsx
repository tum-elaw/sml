export function UeberUns() {
    return (
        <div className="col-12 col-lg-12 mt-6 mb-md-4 mb-lg-0 float-left">
            <h2 className="h2-mktg">Über Uns</h2>
              <div className='mt-3 markdown-body'>
                <p>Als Brückenkopf interdisziplinärer Spitzenforschung hat sich das TUM Center for Digital Public Services (CDPS) als allgemeines Ziel gesetzt, die Digitalisierung rechtssicher und praxistauglich zu gestalten. </p>
                    <p>Die Digitalisierung der alltäglichen zwischenmenschlichen Kommunikation erfolgt größtenteils über Social Media. <br></br>Angestellte im Öffentlichen Dienst kommen nicht nur im beruflichen Kontext mit Social Media in Berührung, sondern führen zumeist ein eigenes Konto oder Profil auf einer Social Media-Plattform. <br></br>Insofern will das CDPS den Angestellten im Öffentlichen Dienst eine Handreichung zur rechtskonformen privaten Nutzung von Social Media bieten und dadurch auch den digitalen Wandel in diesem Bereich fördern.
                    </p><p>
