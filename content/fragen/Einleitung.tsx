        ...
        <div className="col-12 col-lg-12 mt-6 mb-md-4 mb-lg-0 float-left">
            <h2 className="h2-mktg">Einleitung</h2>
              <div className='mt-3'>
                ...
                <p>Die Vorteile von Social Media sind vielen bekannt. Den meisten ist hingegen nicht bekannt, wie man sich auf Social Media-Plattformen rechtskonform verhält bzw. was im Umgang mit Social Media erlaubt oder nicht erlaubt ist. Die folgenden Ausführungen des Quick Gui-des sollen Unklarheiten beseitigen und einen ersten Einblick darin geben, was bei der pri-vaten Nutzung von Social Media aus rechtlicher Sicht zu beachten ist. Dabei haben wir uns an insgesamt zwölf in der Praxis besonders häufig auftretenden Fragen orientiert.</p>
